...
The archetypes are a complex and proteiform concept in Jung's work, with multiple, sometimes exclusive and conflicting definitions. They are, at the same time, the product of his investigations (through the analysis of texts, stories, or mental productions of patients), as well as a tool used to give meaning to obscure patterns and objects. Jung himself mentions earlier roots and sources of inspiration, such as Plato's *Idea* as the origin or philosophical basis for his theory of archetypes. Jung also linked them to Kantian *categories*, i.e., to a priori conditions for possible experiences, as the imagination and fantasy counterparts of Kant's logical categories of reason. However, as we will see, the initial influence might have been less that of these major philosophers, but actually related to an interest in the esoteric and the occult, quite popular in the intellectual milieu of Jung's time.
