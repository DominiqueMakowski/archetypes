...
### The Physical World is Chaos

Theseus' ship thought experiment (EXPALAIN) underlines the fact that the physical world is, at the fundamental level, chaotic and uniform. There is no "objects" in themselves. And yet we create meaning, which is necessary to life. The primordial feature of this given meaning is the distinction between external and the internal world, allowing to organism to exist and function (and life itself to emerge, according to the Free Energy principle).
...
<!-- Order vs. Chaos: chaos is outside and inside, and the mother gives order to the chaos inside, and the father to the chaos outside. Goal of life is to reduce chaos (uncertainty) and bring order (free energy minimization) -->

<!-- The "hero", the defeater of the serpent (the external/internal chaos) is also the Super-ego (surmoi) and the serpent is the "ça" (id). -->
...
A secundary axis could be the real vs. the unreal.
...
The two waters. Waters (blue) the sky and waters from below the earth (as water appears wherever we dig deep enough, thus suggesting that land sits on water).
...
> _The Serpent shows the way to hidden things._
>
