...
```{r, echo = FALSE, out.width = "49%", fig.show='hold', fig.cap="The oldest clear depictions of an ouroboros, appearing on the second gilded shrine of Tutankhamun (14th century BC)."}
